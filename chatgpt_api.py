...
config = Config("C:/Users/paulm/OneDrive/Desktop/Backend/MyRetailProtocolProject/.env")
...
def fetch_protocols_from_files(role):
    directory = r'C:\Users\paulm\OneDrive\Desktop\Backend\MyRetailProtocolProject\protocols\{}'.format(role)
    formatted_protocols = ""
